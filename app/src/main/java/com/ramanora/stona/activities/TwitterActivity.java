...
public class TwitterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webviewProducts = (WebView) findViewById(R.id.webviewtwitter);
        ...
        webviewProducts.setWebViewClient(new WebViewClient() {
         ...
         /*   public void onPageStarted(WebView view, String url, Bitmap favicon) {
                dialog = ProgressDialog.show(TwitterActivity.this, null,
            ...
            public void onReceivedError(WebView view, int errorCode,
                ...
                webviewProducts.loadUrl(UrlConstants.URL_SOCIAL_TWITTER);
