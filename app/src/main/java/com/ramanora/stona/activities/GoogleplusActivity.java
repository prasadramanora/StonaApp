...
public class GoogleplusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webviewProducts = (WebView) findViewById(R.id.webviewgoogleplus);
        ...
        webviewProducts.setWebViewClient(new WebViewClient() {
          ...
          /*  public void onPageStarted(WebView view, String url, Bitmap favicon) {
                dialog = ProgressDialog.show(YoutubeActivity.this, null,
            ...
            public void onReceivedError(WebView view, int errorCode,
                ...
                // error page
                Toast.makeText(GoogleplusActivity.this,
                        "The Requested Page Does Not Exist", Toast.LENGTH_SHORT).show();
                webviewProducts.loadUrl(UrlConstants.URL_SOCIAL_Google);
        ...
        if (!Utils.isNetworkAvailable(GoogleplusActivity.this)) {
