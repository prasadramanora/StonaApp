 ...
 */
public class CountryAboutUs extends Fragment {




    public CountryAboutUs() {
        // Required empty public constructor
    }

    TextView mCompanyname;
    TextView mfirstname,azmobile,mdesignation,mcity,mcountry,memail,mwebsite,azcontactpersonname,aztelephone,azcompanyprofile,azdesignamtion,azcompanynameinfo;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.country_about_us, null);
