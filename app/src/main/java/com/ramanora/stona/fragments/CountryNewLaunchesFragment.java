...
import com.ramanora.stona.bean.CountryExhibitorListPojo;
 ...
 */
public class CountryNewLaunchesFragment extends Fragment {

    TextView txtCountrynewlauches;
    CountryExhibitorListPojo azExhibitorListPojo;
    String companyname;
    private ArrayList<AZExhibitorListPojo> listprod;
    public CountryNewLaunchesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txtCountrynewlauches = (TextView) view.findViewById(R.id.hallnewlauches);
        ...
        if(listprod.size()>0){
            ...
            if (newlaunch.equalsIgnoreCase("null") || newlaunch==null || newlaunch.equalsIgnoreCase("") ) {
                ...
                txtCountrynewlauches.setText("To know more connect with us. "+ "\n\n" + "" +  website  +"\n \n " + Phone +"\n \n " + Mobile +"\n \n " + Email) ;

            }
           else
           {
               txtCountrynewlauches.setText(newlaunch);
               ...
               for (int i = 0; i < newlaunchlist.length; i++) {
                   ...
                   txtCountrynewlauches.setText(temp);
            ...
            txtCountrynewlauches.setText("No data");
        }
